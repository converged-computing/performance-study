...
#SBATCH --nodes=128
#SBATCH --output=qs-output-N128n4096t3-slurm.txt
#SBATCH --error=qs-error--N128n4096t3-slurm.txt
#SBATCH --time=0:10:00
#SBATCH --exclusive
...
/usr/bin/time -p mpirun -N 128 -x UCX_POSIX_USE_PROC_LINK=n --map-by ppr:32:node \
