...
#SBATCH --nodes=32
#SBATCH --output=qs-output-N32n1024t3-slurm.txt
#SBATCH --error=qs-error--N32n1024t3-slurm.txt
#SBATCH --time=0:10:00
#SBATCH --exclusive
...
/usr/bin/time -p mpirun -N 32 -x UCX_POSIX_USE_PROC_LINK=n --map-by ppr:32:node \
