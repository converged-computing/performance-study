...
/usr/bin/time -p mpirun -n 128 -x UCX_POSIX_USE_PROC_LINK=n  --map-by ppr:8:node \
	...
	--layout GDZ --dset 8 --zones 128,128,128 --gset 16 --groups 64 --niter 50 --legendre 8 --quad 8 --procs 4,8,4
