...
#export SINGULARITY_CUDA_VISIBLE_DEVICES="0,1,2,3,4,5,6,7"
/usr/bin/time -p mpirun -n 8 --map-by ppr:8:node -x UCX_POSIX_USE_PROC_LINK=n  \
     singularity exec --nv --env CUDA_VISIBLE_DEVICES="0,1,2,3,4,5,6,7" \
    ...
    --niter 50 --legendre 8 --quad 8 --procs 2,2,2
